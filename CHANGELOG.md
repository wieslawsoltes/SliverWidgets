...
- Added Uno/WinUI `SliverDataGridRowsVirtualizingLayout`, MAUI `SliverDataGridCollectionView`, and shared real DataGrid column metadata so gallery rows are native virtualized row containers instead of duplicated fixed-width sample grids.
