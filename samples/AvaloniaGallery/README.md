...
- DataGrid sliver: `SliverVirtualizingDataGridRowsPanel` over 100,000 shared rows with variable heights, dynamic text, sorting, filtering, and horizontal column scrolling.
